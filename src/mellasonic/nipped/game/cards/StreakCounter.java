...
/*
 ...
 2022/06/01
 Time spent: 1 hour
 New features/processing: Create Streak Counter, Add & position text, set spacing, add icons; create renderStreak(), getter/setter methods
*/
